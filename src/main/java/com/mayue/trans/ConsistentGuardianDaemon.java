...
public class ConsistentGuardianDaemon {
	...
	private HashMap<IdempotentTypeDeclare.TransactionId, Object[]/*lastRetryTime,retried count*/> mapRetryInfo = new HashMap<IdempotentTypeDeclare.TransactionId, Object[]>();
	...
	private void updateRetryInfo(LogCollection logCollection,boolean success) {
		IdempotentTypeDeclare.TransactionId id = new IdempotentTypeDeclare.TransactionId(logCollection.getAppId(), logCollection.getBusCode(), logCollection.getTrxId());
		if(success){
