...
import com.mayue.trans.EasyTransFacade;
...
public class OrderService {
	...
	public Future<ExpressDeliverAfterTransMethod.AfterMasterTransMethodResult> buySomething(int userId, long money){
		 ...
		 */
		WalletPayTccMethod.WalletPayTccMethodRequest deductRequest = new WalletPayTccMethod.WalletPayTccMethodRequest();
		...
		Future<WalletPayTccMethod.WalletPayTccMethodResult> deductFuture = null;
		 ...
		 */
		AccountingCpsMethod.AccountingRequest accountingRequest = new AccountingCpsMethod.AccountingRequest();
		...
		if(checkExecuteForTestCase(accountingRequest.getClass())){
			...
			Future<AccountingCpsMethod.AccountingResponse> accountingFuture = transaction.execute(accountingRequest);
		}
		 ...
		 */
		ExpressDeliverAfterTransMethod.ExpressDeliverAfterTransMethodRequest expressRequest = new ExpressDeliverAfterTransMethod.ExpressDeliverAfterTransMethodRequest();
		expressRequest.setPayAmount(money);
		expressRequest.setUserId(userId);
		Future<ExpressDeliverAfterTransMethod.AfterMasterTransMethodResult> expressResult = null;
		...
		try {
			if(deductFuture != null){
				WalletPayTccMethod.WalletPayTccMethodResult walletPayTccMethodResult = deductFuture.get();
